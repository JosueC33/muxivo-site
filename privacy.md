...
stay on your own Mac, iPhone, or iPad and are never sent anywhere:
...
from your Mac, iPhone, or iPad. It is reachable only on your own network, serves only the single
...
address you supplied. Credentials are stored in the system Keychain, never in a
...
your own private iCloud account so they match across your devices. This is off by
